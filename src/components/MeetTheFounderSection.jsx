...
export default function MeetTheFounderSection() {
    return (
      <section className="relative w-full bg-[#141414] text-white py-16 px-4 md:px-8 flex items-center overflow-x-hidden">
      <div className="relative z-10 max-w-7xl mx-auto text-left">
        {/* Main Heading */}
        <h2 className="text-2xl md:text-5xl font-light font-family-outfit">
        Sales Catalyst
        </h2>
        <h3 className="text-3xl md:text-6xl font-bold mt-4 font-family-outfit">
        Meet The Founder
        </h3>
        ...
        <div className="flex flex-col justify-center order-2 md:order-1">
          <p className="text-gray-300 font-family-outfit text-base md:text-lg">
          Based in Buffalo, New York, Chris Lubick is an entrepreneurial executive leader with over 20 years of experience in sales and business development across global technology and professional services markets. Over the course of his career, Chris’s teams have collectively generated over $1 billion in revenue.
          </p>

          <p className="text-gray-300 text-base md:text-lg mt-4 md:mt-6 font-family-outfit bg-[#252525] p-4 rounded-xl">
        ...
        <div className="relative rounded-2xl h-[400px] md:h-[500px] flex items-center justify-center order-1 md:order-2 mt-0 md:-mt-28">
          <img 
            src={founder} 
            alt="Founder" 
            className="rounded-2xl h-full w-80 object-cover" 
          />
